...
//VuxInter/Demo/_1T_Begin.c/DeltaTime_8917fab7.h

//$$VUNIT(BEGIN,TESTFUNCPLUG/DeltaTime(TIME_TMR*,TIME_TMR*))
#ifdef _VUDEBUG
static TIME_TMR DeltaTime_vpls_(TIME_TMR* Src,TIME_TMR* Dst){ VuxDbgBrkP()
{
    int ns;
    TIME_TMR DeltaT;
    ns = Src->Ns - Dst->Ns;
...
#else
static TIME_TMR DeltaTime_vpls_(TIME_TMR* Src,TIME_TMR* Dst){__VUFNINFO__("DeltaTime","TIME_TMR",0);VuxDbp(0,0,9);
{
...
static TIME_TMR DeltaTime_vpls(TIME_TMR* Src,TIME_TMR* Dst)
{
	VuxIncRunTimes();
...
//$$VUNIT(END,TESTFUNCPLUG/DeltaTime(TIME_TMR*,TIME_TMR*))
