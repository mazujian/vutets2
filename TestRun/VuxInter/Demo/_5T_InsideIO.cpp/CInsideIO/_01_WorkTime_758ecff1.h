...
//VuxInter/Demo/_5T_InsideIO.cpp/CInsideIO/_01_WorkTime_758ecff1.h

//$$VUNIT(BEGIN,TESTFUNCPLUG/CInsideIO::_01_WorkTime(int*))
#ifdef _VUDEBUG
BOOL CInsideIO::_01_WorkTime_vpls_(int* pWorkTime){ VuxDbgBrkP()
{
...
#else
BOOL CInsideIO::_01_WorkTime_vpls_(int* pWorkTime){__VUFNINFO__("_01_WorkTime","BOOL",0);VuxDbp(0,0,12);
{
...
BOOL CInsideIO::_01_WorkTime_vpls(int* pWorkTime)
{
	VuxIncRunTimes();
    if(VuxRateTesting()) {return CInsideIO::_01_WorkTime(pWorkTime);}
...
//$$VUNIT(END,TESTFUNCPLUG/CInsideIO::_01_WorkTime(int*))
