...
#ifndef __MCK__COMPILER_GCC_4_INCLUDE_TIME_H__
#define __MCK__COMPILER_GCC_4_INCLUDE_TIME_H__
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"char*","arg_1",(const void*)&arg_1}}; if(VuxMck("_strtime",&vmckrt,vmckds,1,"",1256,0,4)) return *(char**)vmckrt;{
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"char*","arg_1",(const void*)&arg_1}}; if(VuxMck("_strdate",&vmckrt,vmckds,1,"",1274,0,4)) return *(char**)vmckrt;{
...
{if(!VuxMck("tzset",0,0,0,"",1328,0,4)) {
    tzset();}}
#endif
...
{void* vmckrt=0; if(VuxMck("clock",&vmckrt,0,0,"",1336,0,4)) return *(clock_t*)vmckrt;{
    return clock();}}
#endif
...
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"wchar_t*","arg_1",(const void*)&arg_1},{2,"size_t","arg_2",(const void*)&arg_2},{3,"wchar_t*","arg_3",(const void*)&arg_3},{4,"struct tm*","arg_4",(const void*)&arg_4}}; if(VuxMck("wcsftime",&vmckrt,vmckds,4,"",1351,0,4)) return *(size_t*)vmckrt;{
...
{if(!VuxMck("_tzset",0,0,0,"",1364,0,4)) {
    _tzset();}}
#endif
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"time_t*","arg_1",(const void*)&arg_1}}; if(VuxMck("localtime",&vmckrt,vmckds,1,"",1392,0,4)) return *(struct tm**)vmckrt;{
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"time_t*","arg_1",(const void*)&arg_1}}; if(VuxMck("time",&vmckrt,vmckds,1,"",1393,0,4)) return *(time_t*)vmckrt;{
    return time(arg_1);}}
#endif
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"time_t*","arg_1",(const void*)&arg_1}}; if(VuxMck("ctime",&vmckrt,vmckds,1,"",1419,0,4)) return *(char**)vmckrt;{
    return ctime(arg_1);}}
#endif
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"struct tm*","arg_1",(const void*)&arg_1}}; if(VuxMck("asctime",&vmckrt,vmckds,1,"",1425,0,4)) return *(char**)vmckrt;{
...
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"time_t","arg_1",(const void*)&arg_1},{2,"time_t","arg_2",(const void*)&arg_2}}; if(VuxMck("difftime",&vmckrt,vmckds,2,"",1449,0,4)) return *(double*)vmckrt;{
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"struct tm*","arg_1",(const void*)&arg_1}}; if(VuxMck("mktime",&vmckrt,vmckds,1,"",1467,0,4)) return *(time_t*)vmckrt;{
    return mktime(arg_1);}}
#endif
...
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"char*","arg_1",(const void*)&arg_1},{2,"size_t","arg_2",(const void*)&arg_2},{3,"char*","arg_3",(const void*)&arg_3},{4,"struct tm*","arg_4",(const void*)&arg_4}}; if(VuxMck("strftime",&vmckrt,vmckds,4,"",1482,0,4)) return *(size_t*)vmckrt;{
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"time_t*","arg_1",(const void*)&arg_1}}; if(VuxMck("gmtime",&vmckrt,vmckds,1,"",1487,0,4)) return *(struct tm**)vmckrt;{
    return gmtime(arg_1);}}
#endif
